...
import { featuredProjects, projectBySlug, projects, services, site } from './index';
...
describe('public content relationships', () => {
	...
	it('links every service to a known project', () => {
		for (const service of services) expect(projectBySlug[service.relatedProjectSlug]).toBeDefined();
	});
