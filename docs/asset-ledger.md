...
| `case-study-media`     | Seven Butter, NRG Commerce, and EvoSnake interface screenshots              | MengChe Dev CDN under `/projects/*.webp`               | Original project media or collaborator-approved publication                      | Relevant case-study pages only; customer and operational data must be synthetic or redacted | Approved |
